> THIS PROJECT IS NO LONGER WORKING AS THERE IS A MAJOR REVAMP IN THE API OF THE 3RD PARTY API USED (Exchangerate.host). PLEASE VISIT THE UPDATED VERSION [HERE](https://github.com/desmondtong/Currency-Exchange-App-v2) LEVERAGING A DIFFERENT CURRENCY CONVERSION API.
